...
class RobotHardware:
    ...
    def set_joint_positions(self, joint_setpoint, joint_velocity_setpoint):
        # print(joint_setpoint)
        self.joint_positions = np.clip(joint_setpoint, self.joint_lower_limits, self.joint_upper_limits)
        self.joint_velocities = joint_velocity_setpoint
    ...
    def update_motor_positions(self):
        ...
        unclipped_velocity = self.joint_velocities
    ...
    def clippingCallback(self, data):
        self.set_joint_positions(np.array(data.position), np.array(data.velocity))
        #self.set_joint_velocity(np.array(data.velocity))
